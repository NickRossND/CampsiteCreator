...
type MobileTab = 'items' | 'properties' | 'settings';
...
function IconProperties() {
  return (
    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 11-3 0m3 0a1.5 1.5 0 10-3 0M3.75 6H7.5M21 12h-3.75m0 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0M3.75 12H13.5M10.5 18h9.75m-9.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0M3.75 18H7.5" />
    </svg>
  );
}
...
export default function App() {
  ...
  const selectedId = useCampsiteStore(s => s.selectedId);

  // Auto-open properties panel on mobile when an item is selected
  useEffect(() => {
